...
timeline
    ...
    2023 : SKEL (MPII) : 生物力学骨架+皮肤双输出, 46关节骨骼
...
### 2.5 SKEL — 生物力学骨架模型 (2023)

> 详见 [[02_L2_核心技术与算法 (Core Tech & Algorithms)/2026-05-23-SKEL-生物力学参数化人体模型.md|SKEL 笔记]]

**核心思想**：与 SMPL 系的纯表面建模不同，SKEL 同时建模**皮肤网格 + 骨架网格**，生成解剖学准确的 3D 人体。

| 维度 | SKEL |
|------|------|
| 形状参数 | 10 维（第1维≈身高，第2维≈体重） |
| 姿态参数 | 46 维（46 个关节角度，弧度） |
| 输出 | 皮肤网格 + 骨架网格 + 解剖学关节位置 |
| 可微性 | ✅ 端到端可微，支持 Mocap/SMPL 序列拟合 |
| 许可证 | 非商用科研许可 |

**设计特点**：
- 骨骼关节定义独立于表面形状（与 MHR 的解耦思路一致，但早于 MHR）
- 可微分管道适合嵌入深度学习重建管线
- 已被 [[2026-05-23-HSMR-生物力学骨架人体重建.md|HSMR]]（CVPR 2025 Oral）用作基础骨架表示

**与 SMPL 的关键区别**：SMPL 的关节从顶点回归（受形状影响），SKEL 的骨架网格是显式建模的解剖学结构。
...
| [[02_L2_核心技术与算法 (Core Tech & Algorithms)/2026-05-23-HSMR-生物力学骨架人体重建.md|HSMR]] | **SKEL** | 生物力学准确骨架重建，CVPR 2025 Oral |
| [[02_L2_核心技术与算法 (Core Tech & Algorithms)/2026-05-23-GEM-统一人体运动估计与生成模型.md|GEM]] | SMPL | 统一运动估计+生成，ICCV 2025 Highlight |
| [[02_L2_核心技术与算法 (Core Tech & Algorithms)/2026-05-23-GEM-X-全身SOMA人体姿态估计.md|GEM-X]] | **SOMA** | 全身77关节SOMA姿态估计，ICCV 2025 |
